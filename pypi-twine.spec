...
Source0  : https://files.pythonhosted.org/packages/d3/cc/8025ad5102a5c754023092143b8b511e184ec087dfbfb357d7d88fb82bff/twine-5.0.0.tar.gz
...
%prep
%setup -q -n twine-5.0.0
cd %{_builddir}/twine-5.0.0
pushd ..
cp -a twine-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707758449
