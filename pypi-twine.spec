...
%prep
%setup -q -n twine-3.7.1
cd %{_builddir}/twine-3.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641598072
...
cp %{_builddir}/twine-3.7.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-twine/7f6eb21389a5af4de0e7927a25fe236bc0cd3a75
