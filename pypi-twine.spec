...
Source0  : https://files.pythonhosted.org/packages/d1/3e/ce331d7e215abdc16c53e65f8506bfccf4840ce191b709a37b8c83cc32c7/twine-3.8.0.tar.gz
...
%prep
%setup -q -n twine-3.8.0
cd %{_builddir}/twine-3.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643996027
...
cp %{_builddir}/twine-3.8.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-twine/7f6eb21389a5af4de0e7927a25fe236bc0cd3a75
