...
Source0  : https://files.pythonhosted.org/packages/66/6d/dcf5c58dbc468b52f20f2de0470caaae09a7ab91d847f7ca4a786137ca4f/twine-5.1.0.tar.gz
...
%prep
%setup -q -n twine-5.1.0
cd %{_builddir}/twine-5.1.0
pushd ..
cp -a twine-5.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715905321
