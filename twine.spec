...
Source0  : https://files.pythonhosted.org/packages/14/54/2fc5732362649f4b6f4c245c17dc5a526148b1fb2c3a89176a2ef950628a/twine-3.2.0.tar.gz
...
%prep
%setup -q -n twine-3.2.0
cd %{_builddir}/twine-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593020559
...
cp %{_builddir}/twine-3.2.0/LICENSE %{buildroot}/usr/share/package-licenses/twine/7f6eb21389a5af4de0e7927a25fe236bc0cd3a75
