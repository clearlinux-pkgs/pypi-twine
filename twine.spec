...
Source0  : https://files.pythonhosted.org/packages/61/ac/44da2609e4ec5c7a2328fd71d862f40dcd045601cb5197830b52a60513d7/twine-3.4.0.tar.gz
...
%prep
%setup -q -n twine-3.4.0
cd %{_builddir}/twine-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615910737
...
cp %{_builddir}/twine-3.4.0/LICENSE %{buildroot}/usr/share/package-licenses/twine/7f6eb21389a5af4de0e7927a25fe236bc0cd3a75
