...
%prep
%setup -q -n twine-3.4.1
cd %{_builddir}/twine-3.4.1
...
cp %{_builddir}/twine-3.4.1/LICENSE %{buildroot}/usr/share/package-licenses/twine/7f6eb21389a5af4de0e7927a25fe236bc0cd3a75
